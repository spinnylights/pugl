...
/**
   ...
   All keys are expressed as a Unicode code point.  This enumeration defines
   constants to represent special keys that do not have a standard code point,
   and some convenience constants for control characters.  Keys that do not
   have a standard code point use values in the Unicode Private Use Area.
*/
typedef enum {
	// ASCII control codes
